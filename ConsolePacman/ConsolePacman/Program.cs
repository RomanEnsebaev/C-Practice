    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {              
                ...
                Console.WriteLine("Ghost ate you! Loser!");
                Console.ReadKey();
            }
        }
        ...
        static char[,] ReadMap(string mapName, out int packmanX, out int pacmanY,out int ghostX, out int ghostY, ref int allDots)
        {
            packmanX = 0;
            pacmanY = 0;
            ghostX = 0;
